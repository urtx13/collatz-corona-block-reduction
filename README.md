...
$$2^{24}-3^{15}=(2^8-3^5)(2^{16}+2^8 3^5+3^{10})=13\cdot 186793.$$
...
$$2^{16}-3^{10}=(2^8-3^5)(2^8+3^5)=13\cdot 499.$$
...
$$2^{15}-3^9=(2^5-3^3)(2^{10}+2^5 3^3+3^6)=5\cdot 2617.$$
...
$$2^{26}-3^{16}=(2^{13}-3^8)(2^{13}+3^8)=1631\cdot 14753=7\cdot 233\cdot 14753.$$
